%% Import options
cd '\\131.155.50.88\Larry Fitzpatrick\20231023_MDA-MB-468_4-colour\Analysis'   % Set directory
N=10;    % Set number of folders with images (roisets)
filenameSpots='Tracks_Tf_PDL1_%d.csv';    % Set name of trajectory file (change the for %d). They should be numbered from 1 to N
...
nameTrackInfoRed = 'ROI_%d_Track_Info_PDL1.csv';         % Tracks information of a single ROI
nameTrackInfoAllRed = 'Track_Information_All_PDL1.csv';  % Combined tack information of all ROIs
nameCellInfoMeanRed = 'Cell_Information_All_PDL1.csv';   % Average single cell infromation (includes track information, plus density and step count)
nameCellInfoMedianRed = 'Cell_Information_Median_PDL1.csv';  
nameCellInfoSTDRed = 'Cell_Information_STD_PDL1.csv';  

nameTrackInfoGreen = 'ROI_%d_Track_Info_Tf.csv';         % Tracks information of a single ROI
nameTrackInfoAllGreen = 'Track_Information_All_Tf.csv';  % Combined tack information of all ROIs
nameCellInfoMeanGreen = 'Cell_Information_All_Tf.csv';   % Average single cell infromation (includes track information, plus density and step count)
nameCellInfoMedianGreen = 'Cell_Information_Median_Tf.csv';  
nameCellInfoSTDGreen = 'Cell_Information_STD_Tf.csv';  
